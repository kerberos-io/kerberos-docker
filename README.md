...
A Docker image is available on the Docker Hub. Before you can run this image you will have to get Docker or Docker-machine (Windows/OSX) installed. After the installation you can use `docker-compose` to get Kerberos.io up and running. More detailed information can be found [here](https://doc.kerberos.io/2.0/installation/Docker).
